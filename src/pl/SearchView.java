            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!wordText.isEmpty()) {
                    ...
                    if (!result.equals("Word not found.")) {
                        ...
                        // If word not found, launch the DictionaryScraperApp
                        int choice = JOptionPane.showConfirmDialog(SearchView.this,
                                "Word not found: " + wordText + ". Would you like to scrape for its meaning?",
                                "Word Not Found", JOptionPane.YES_NO_OPTION);
                        if (choice == JOptionPane.YES_OPTION) {
                            // Open the Dictionary Scraper App
                            SwingUtilities.invokeLater(() -> {
                                DictionaryScraperApp scraperApp = new DictionaryScraperApp();
                                scraperApp.setVisible(true); // Show the scraper app
                            });
                        }
                    }
                } else {
